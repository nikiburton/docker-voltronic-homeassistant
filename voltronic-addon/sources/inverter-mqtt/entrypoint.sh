...
watch -n 300 /opt/sources/inverter-mqtt/mqtt-init.sh > /dev/null 2>&1 &
...
/opt/sources/inverter-mqtt/mqtt-subscriber.sh &

# execute exactly every 30 seconds...
watch -n 30 /opt/sources/inverter-mqtt/mqtt-push.sh > /dev/null 2>&1
